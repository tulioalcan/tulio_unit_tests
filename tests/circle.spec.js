...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    // Teste se o objeto retornado possui 3 propriedades. usei toHaveLength - verificar que um objeto tem uma propriedade .length 
    ...
    expect(circle(3)).toEqual(expect.objectContaining({ circumference: 2 * 3.14 
      * 3 }));
