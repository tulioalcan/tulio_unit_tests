...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {  
    ...
    it('verifica se retorna udefined quando não recebe parâmetros', () => {
      expect(getCharacter()).toBe(undefined);
    });    
    // Teste se a função retorna o objeto correto para o parâmetro 'Arya',
    it('verifica se retorna um objeto correto para o parâmetro "Arya"', () => {
    ...
    it ('Verifica se retorna undefined para nome que não está na tabela', () => {
